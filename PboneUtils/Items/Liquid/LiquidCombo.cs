...
namespace PboneUtils.Items.Liquid
{
    public class LiquidCombo : PboneUtilsItem
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.BottomlessBucket).AddIngredient(ItemID.BottomlessLavaBucket).AddIngredient(ItemID.BottomlessHoneyBucket).AddIngredient(ItemID.BottomlessShimmerBucket).AddIngredient(ItemID.UltraAbsorbantSponge).AddTile(TileID.AlchemyTable).Register();
        }
    }
}
